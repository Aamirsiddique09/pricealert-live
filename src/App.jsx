...
export default function App() {
  ...
  const doSearch = useCallback(async (q) => {
    ...
    try {
      // Secure proxy — API key stays on server, never in browser
      const url = `${CONFIG.SEARCH_API}?q=${encodeURIComponent(q)}&gl=${c.gl}&hl=${c.hl}`;
